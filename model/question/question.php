...
class post extends Entity {
    ...
    public function create() {
        ...
        if ( $error = $this->validate_questions( $data ) ) return $error;
    ...
    {
        $data = $this->getRequestPostData();
        if ( $error = $this->validate_questions( $data, true ) ) return $error;
    ...
    public function validate_questions( $data, $edit = false ) {
        $create = ! $edit;
        if ( $create ) {
            if ( empty( $data['question'] ) ) return error( -40200, 'input question');
    ...
    private function getRequestPostData()
    {
        ...
        */
        ...
        $names = [ 'id', 'question','choice1','choice2', 'choice3', 'choice4', 'answer'
        ];
